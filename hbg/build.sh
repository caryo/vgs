...
gcc ${BUILD_FLAGS} -Wall -Wstrict-prototypes -ansi -pedantic -c engine3.c
gcc ${BUILD_FLAGS} -Wall -Wstrict-prototypes -ansi -pedantic -o engine engine.c engine0.o engine1.o engine2.o engine3.o
